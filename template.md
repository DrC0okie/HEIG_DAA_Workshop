---
title:  |
  | \vspace{-4cm}\includegraphics[height=3cm]{./logoHEIG.png}
  | \vspace{1cm} Workshop - Bluetooth Low Energy
  | \vspace{0.5cm}\large DAA

authors: "Timothée Van Hove, Léo Zmoos"
date: \today
...
header-includes:
    ...
    - \fancyhead[C]{DAA Workshop - Bluetooth Low Energy}
    - \fancyhead[R]{Van Hove, Zmoos\\\today}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.4\textwidth]{/home/tim/Documents/HEIG/DAA/HEIG_DAA_Workshop/figures/Classic-Bluetooth-vs-BLE.png}
\end{figure}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{/home/tim/Documents/HEIG/DAA/HEIG_DAA_Workshop/figures/Bluetooth_comparison_table.png}
\end{figure}
...
1. La gestion des permissions, 2. la détection du device, 3. la connexion au device (GATT server), 4. Le transfert de données entre les devices

Nous vous proposons une application de démo sur notre [repo Github](https://github.com/DrC0okie/HEIG_DAA_Workshop), qui implémente uniquement la détection de devices BLE et la gestion des permissions. L'implémentation des 2 autres fonctionnalités nécessiterait plus de travail.

\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.25\textwidth]{/home/tim/Documents/HEIG/DAA/HEIG_DAA_Workshop/figures/app.jpeg}
\end{figure}
...
- Utiliser la permission `BLUETOOTH_ADVERTISE` si l'application rend l'appareil courant découvrable par d'autres devices.
- Utiliser la permission `BLUETOOTH_CONNECT` pour communiquer avec des appareils Bluetooth déjà appairés.
- Déclarer `ACCESS_FINE_LOCATION` si l'application utilise les résultats de la recherche pour déterminer la localisation.
...
* Dans le cas où nous ne connaissons pas le device, il ne faut jamais faire un scan en boucle. Toujours fixer une limite de temps. 
